...
void rupture(int D);  /// \return funkcja zwraca costam costam
int gamble(); /// \return funkcja zwraca szanse1
...
int gamble() 
{
	return rand()%100+1;  /// \return funkcja zwraca szanse
}
